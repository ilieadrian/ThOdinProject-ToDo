...
function deleteTodoItem(todoIndex, todoList, projectsList) {
  ...
  if (_manipulateDOM__WEBPACK_IMPORTED_MODULE_1__.statusOfUI) {
    ...
    (0,_manipulateDOM__WEBPACK_IMPORTED_MODULE_1__.setupEventListeners)(filteredTodosAfterDeletion, projectsList); // Use filtered list

  } else {
    // For non-filtered view, render all projects and todos
    (0,_index__WEBPACK_IMPORTED_MODULE_0__.renderUI)(projectsList, todoList);
    (0,_manipulateDOM__WEBPACK_IMPORTED_MODULE_1__.setupEventListeners)(todoList, projectsList); // Use complete list
  }
...
const defaultValues = (function () {
  ...
  if (!todoList || todoList.length === 0) {
    todoList = [
      ...
      new _todo__WEBPACK_IMPORTED_MODULE_0__["default"]("Zee7 projects", "lorem20", "2024-10-18", "high", true, "Zee"),
    ];
