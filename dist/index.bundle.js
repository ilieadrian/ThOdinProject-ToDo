        ...
        ulContent += `
            <li class="item" id="item-${element.id}">
                ...
                <div class="action-grup ${element.status ? "finished" : ''}">
                    <p id="due-date">${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(new Date(element.dueDate), "MMM do")}</p>
