...
function deleteTodoItem(todoIndex, todoList, projectsList) {
  console.log("Mode", _index__WEBPACK_IMPORTED_MODULE_0__.currentView.mode)
  console.log("Project", _index__WEBPACK_IMPORTED_MODULE_0__.currentView.project)
  ...
  const projectName = _index__WEBPACK_IMPORTED_MODULE_0__.currentView.project;
    const filteredTodosAfterDeletion = getTodosByProject(todoList, projectName);

  if (_index__WEBPACK_IMPORTED_MODULE_0__.currentView.mode === "projectView") {
    ...
    (0,_handleproject__WEBPACK_IMPORTED_MODULE_2__.handleProjectCountNumber)();
  } else if(_index__WEBPACK_IMPORTED_MODULE_0__.currentView.mode === "todayView"){
    console.log(filteredTodosAfterDeletion)
    ;(0,_index__WEBPACK_IMPORTED_MODULE_0__.renderTodoContainer)(filteredTodosAfterDeletion, null, null);
    (0,_index__WEBPACK_IMPORTED_MODULE_0__.renderProjectContainer)(projectsList, todoList);
    (0,_handleproject__WEBPACK_IMPORTED_MODULE_2__.handleProjectCountNumber)();
    (0,_index__WEBPACK_IMPORTED_MODULE_0__.renderHomeMenu)(todoList);
    (0,_handleproject__WEBPACK_IMPORTED_MODULE_2__.handleProjectCountNumber)();
    console.log("todayView")
  } else if(_index__WEBPACK_IMPORTED_MODULE_0__.currentView.mode === "weekView"){
console.log("weekview")
  } else {
    (0,_index__WEBPACK_IMPORTED_MODULE_0__.renderUI)(projectsList, todoList);
  }

  (0,_index__WEBPACK_IMPORTED_MODULE_0__.setupEventListeners)(todoList, projectsList);
...
const defaultValues = (function () {
  ...
  if (!todoList || todoList.length === 0) {
    todoList = [
      ...
      new _todo__WEBPACK_IMPORTED_MODULE_0__["default"]("Zee3 projects", "lorem20", "2025-01-02", "low", false, "Zee"),
      new _todo__WEBPACK_IMPORTED_MODULE_0__["default"]("Zee4 projects", "lorem20", "2025-01-02", "high", false, "Zee"),
