...
console.log("index.js fired", _manipulateDOM__WEBPACK_IMPORTED_MODULE_5__.currentView)
...
function dueTodayTodosLink(todoList){
  ...
  _manipulateDOM__WEBPACK_IMPORTED_MODULE_5__.currentView.mode = "todayView"
...
function dueThisWeekTodosLink(todoList){
  ...
  _manipulateDOM__WEBPACK_IMPORTED_MODULE_5__.currentView.mode = "weekView"
  renderTodoContainer(dueThisWeekTodos, null, null)
}

function getClickedProjectName(event) {
  _manipulateDOM__WEBPACK_IMPORTED_MODULE_5__.currentView.mode = "projectView"
  ...
  if (target.tagName === 'A') {
    ...
    _manipulateDOM__WEBPACK_IMPORTED_MODULE_5__.currentView.project = projectName;
