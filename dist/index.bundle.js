...
function deleteTodoItem(todoIndex, todoList, projectsList) {
  ...
  console.log(_index__WEBPACK_IMPORTED_MODULE_0__.currentView.mode, _index__WEBPACK_IMPORTED_MODULE_0__.currentView.project)

  if (_index__WEBPACK_IMPORTED_MODULE_0__.currentView.mode === "project") {
...
const defaultValues = (function () {
  ...
  if (!todoList || todoList.length === 0) {
    todoList = [
      ...
      new _todo__WEBPACK_IMPORTED_MODULE_0__["default"]("Zee4 projects", "lorem20", "2024-12-24", "high", false, "Zee"),
