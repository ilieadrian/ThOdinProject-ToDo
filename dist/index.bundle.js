...
function getProjetsByDueDate(todoList) {
  ...
  const dueTodayTodos = todoList.filter(
    (todo) => (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.isToday)(new Date(todo.dueDate)) && !todo._status,
  );
  const dueThisWeekTodos = todoList.filter(
    (todo) => (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.isThisWeek)(new Date(todo.dueDate)) && !todo._status,
  );
...
function deleteProject(idToDelete, projectsList, todoList) {
  ...
  if (projectIndex !== -1 && todosInProject == 0) {
    ...
    _manipulateDOM__WEBPACK_IMPORTED_MODULE_2__.filteredTodos = (0,_handletodos__WEBPACK_IMPORTED_MODULE_3__.getTodosByProject)(todoList, jumpToProject);

    
    (0,_index__WEBPACK_IMPORTED_MODULE_1__.renderTodoContainer)(_manipulateDOM__WEBPACK_IMPORTED_MODULE_2__.filteredTodos, null, jumpToProject)
