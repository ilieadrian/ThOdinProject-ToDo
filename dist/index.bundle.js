    ...
    ulContent += `
            <li class="item" id="item-${element.id}">
                ...
                <div class="action-grup ${element.status ? "finished" : ""}">
                    <p id="due-date">${(0,date_fns__WEBPACK_IMPORTED_MODULE_5__.format)(new Date(element.dueDate), "MMM do")}</p>
...
function addNewTodo(
  ...
  const newTodo = new _todo__WEBPACK_IMPORTED_MODULE_4__["default"](
    todoTitle,
    todoDescription,
    selecteDate,
    selectedPriority,
...
function deleteTodoItem(todoIndex, todoList, projectsList) {
  ...
  console.log("sharedState in DeleteTodo", _sharedState__WEBPACK_IMPORTED_MODULE_0__["default"])
  console.log("Mode in deleteTodoItem", _sharedState__WEBPACK_IMPORTED_MODULE_0__["default"].mode);
  console.log("Project in deleteTodoItem", _sharedState__WEBPACK_IMPORTED_MODULE_0__["default"].project);
  ...
  if (_sharedState__WEBPACK_IMPORTED_MODULE_0__["default"].mode === "projectView") {
    ...
    const { dueTodayTodos } = (0,_handleproject__WEBPACK_IMPORTED_MODULE_3__.getProjetsByDueDate)(todoList);
    ...
    const { dueThisWeekTodos } = (0,_handleproject__WEBPACK_IMPORTED_MODULE_3__.getProjetsByDueDate)(todoList);
  ...
  (0,_handleproject__WEBPACK_IMPORTED_MODULE_3__.handleProjectCountNumber)();
...
console.log("ManipulateDOM fired", _sharedState__WEBPACK_IMPORTED_MODULE_3__["default"])
