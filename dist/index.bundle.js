...
function setupEventListeners(todoList, projectsList) {
    ...
    createProjectButton.addEventListener('click', function(event) {
        ...
        (0,_handleproject__WEBPACK_IMPORTED_MODULE_2__.checkExistingProject)(projectName, projectsList);
