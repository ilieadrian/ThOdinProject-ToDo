...
/* harmony export */ });
/* harmony import */ var _sharedState__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sharedState */ "./src/modules/sharedState.js");
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index */ "./src/modules/index.js");
...
function deleteTodoItem(todoIndex, todoList, projectsList) {
  ...
  if (_sharedState__WEBPACK_IMPORTED_MODULE_0__["default"].mode === "projectView") {
    const projectName = _sharedState__WEBPACK_IMPORTED_MODULE_0__["default"].project;
    const filteredTodosAfterDeletion = getTodosByProject(todoList, projectName);
    (0,_index__WEBPACK_IMPORTED_MODULE_1__.renderTodoContainer)(filteredTodosAfterDeletion, null, projectName);
  } else if (_sharedState__WEBPACK_IMPORTED_MODULE_0__["default"].mode === "todayView") {
    const { dueTodayTodos } = (0,_handleproject__WEBPACK_IMPORTED_MODULE_2__.getProjetsByDueDate)(todoList);
    (0,_index__WEBPACK_IMPORTED_MODULE_1__.renderTodoContainer)(dueTodayTodos, null, null);
  } else if (_sharedState__WEBPACK_IMPORTED_MODULE_0__["default"].mode === "weekView") {
    const { dueThisWeekTodos } = (0,_handleproject__WEBPACK_IMPORTED_MODULE_2__.getProjetsByDueDate)(todoList);
    (0,_index__WEBPACK_IMPORTED_MODULE_1__.renderTodoContainer)(dueThisWeekTodos, null, null);
  } else {
    (0,_index__WEBPACK_IMPORTED_MODULE_1__.renderUI)(projectsList, todoList);
  }
  
  (0,_index__WEBPACK_IMPORTED_MODULE_1__.renderProjectContainer)(projectsList, todoList);
  (0,_index__WEBPACK_IMPORTED_MODULE_1__.renderHomeMenu)(todoList);
  (0,_handleproject__WEBPACK_IMPORTED_MODULE_2__.handleProjectCountNumber)();

  if (todoList.length === 0) {
    console.log("(todoList.length === 0) case");
    (0,_index__WEBPACK_IMPORTED_MODULE_1__.handleEmptyProjectPage)();
  }
}
...
/* harmony import */ var _sharedState__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sharedState */ "./src/modules/sharedState.js");
/* harmony import */ var _handleproject__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./handleproject */ "./src/modules/handleproject.js");
        ...
        <div class="content-container">
            <section class="menu">
                ...
                <ul id="projects" class="menu-links">
                    ${(0,_handleproject__WEBPACK_IMPORTED_MODULE_2__.getProjects)(projectsList, todoList)}
                </ul>
            ...
            <section class="todo-container">
                <ul class="items-list" id="item-list-X-X">
                    ${(0,_handletodos__WEBPACK_IMPORTED_MODULE_3__.displayToDods)(todoList)}
                </ul>
            </section>
        </div>
...
function renderTodoContainer(
  ...
  if (filteredTodos.length > 0) {
    container.innerHTML = `
        <ul class="items-list">
            ${(0,_handletodos__WEBPACK_IMPORTED_MODULE_3__.displayToDods)(filteredTodos)}  
        </ul>
    `;
  } else {
    container.innerHTML = `
    ...
    if(_sharedState__WEBPACK_IMPORTED_MODULE_1__["default"].mode === "todayView"){
      container.innerHTML = `
      <div class="items-list">
    ...
    if(_sharedState__WEBPACK_IMPORTED_MODULE_1__["default"].mode === "weekView"){
      container.innerHTML = `
      <div class="items-list">
...
function handleEmptyProjectPage() {
  ...
  console.log("sharedState.project in handleEmptyProjectPage", _sharedState__WEBPACK_IMPORTED_MODULE_1__["default"].project)
  ...
  const { projectsList, todoList } = _startup__WEBPACK_IMPORTED_MODULE_4__.defaultValues;
  ...
  let idToDelete = getActiveId(_sharedState__WEBPACK_IMPORTED_MODULE_1__["default"].project, projectsList);
  ...
  if (deleteBtn) {
    ...
    deleteBtn.addEventListener("click", function () {
      ...
      (0,_handleproject__WEBPACK_IMPORTED_MODULE_2__.deleteProject)(idToDelete, projectsList, todoList);
    });
  } else {
    return
...
function setupEventListeners(todoList, projectsList) {
  ...
  if (todosDueContainer) {
    todosDueContainer.addEventListener("click", (event) => {
      ...
      if (target.id === "today-link") {
        ...
        _sharedState__WEBPACK_IMPORTED_MODULE_1__["default"].mode = "all";
        _sharedState__WEBPACK_IMPORTED_MODULE_1__["default"].project = null;
  ...
  if(addToDoBTN){
    addToDoBTN.addEventListener('click', () => (0,_manipulateDOM__WEBPACK_IMPORTED_MODULE_5__.openToDoModal)(modalContainer, projectsList));
  }

  if(addProjectBTN){
    addProjectBTN.addEventListener('click', () => (0,_manipulateDOM__WEBPACK_IMPORTED_MODULE_5__.openProjectModal)(modalContainer, projectsList));
  }
  ...
  modalContainer.addEventListener("click", function (event) {
    ...
    if (event.target && event.target.id === "create-todo") {
      ...
      if (todoTitle && selectedProject && selecteDate && selectedPriority) {
        (0,_handletodos__WEBPACK_IMPORTED_MODULE_3__.addNewTodo)(
          todoTitle,
          todoDescription,
          selectedProject,
          selecteDate,
    ...
    if (event.target && event.target.id === "edit-modal-todo") {
      ...
      (0,_handletodos__WEBPACK_IMPORTED_MODULE_3__.editTodo)(
        projectId,
        todoTitle,
        todoDescription,
        selectedProject,
...
function modifyTodoStatus(elementId, target, projectsList, todoList){
  ...
  } else if(_sharedState__WEBPACK_IMPORTED_MODULE_1__["default"].mode === "weekView"){
    const { dueThisWeekTodos } = (0,_handleproject__WEBPACK_IMPORTED_MODULE_2__.getProjetsByDueDate)(todoList);
    renderTodoContainer(dueThisWeekTodos, null, null)
  } else if(_sharedState__WEBPACK_IMPORTED_MODULE_1__["default"].mode === "projectView"){
    const filteredTodos = (0,_handletodos__WEBPACK_IMPORTED_MODULE_3__.getTodosByProject)(todoList, _sharedState__WEBPACK_IMPORTED_MODULE_1__["default"].project)
    renderTodoContainer(filteredTodos, null, _sharedState__WEBPACK_IMPORTED_MODULE_1__["default"].project)
  } else {
    renderUI(projectsList, todoList);
  }
...
function dueTodayTodosLink(todoList){
  const { dueTodayTodos } = (0,_handleproject__WEBPACK_IMPORTED_MODULE_2__.getProjetsByDueDate)(todoList);
  _sharedState__WEBPACK_IMPORTED_MODULE_1__["default"].mode = "todayView"
  renderTodoContainer(dueTodayTodos, null, null)
}

function dueThisWeekTodosLink(todoList){
  const { dueThisWeekTodos } = (0,_handleproject__WEBPACK_IMPORTED_MODULE_2__.getProjetsByDueDate)(todoList);
  _sharedState__WEBPACK_IMPORTED_MODULE_1__["default"].mode = "weekView"
  renderTodoContainer(dueThisWeekTodos, null, null)
}

function getClickedProjectName(event) {
  _sharedState__WEBPACK_IMPORTED_MODULE_1__["default"].mode = "projectView"
  const { todoList } = _startup__WEBPACK_IMPORTED_MODULE_4__.defaultValues;
  const target = event.target;

  if (target.tagName === 'A') {
    event.preventDefault();
    const projectName = target.textContent.trim();
    _sharedState__WEBPACK_IMPORTED_MODULE_1__["default"].project = projectName;
    const filteredTodos = (0,_handletodos__WEBPACK_IMPORTED_MODULE_3__.getTodosByProject)(todoList, projectName)
...
function handleToDoListActions(todoList, projectsList, modalContainer, event){
  ...
  if (target.closest(".view-btn")) {
    (0,_manipulateDOM__WEBPACK_IMPORTED_MODULE_5__.openViewModal)(todoIndex, todoList, modalContainer);
  } else if (target.closest(".edit-btn")) {
    if (todoList[todoIndex]) {
      (0,_manipulateDOM__WEBPACK_IMPORTED_MODULE_5__.openEditModal)(todoIndex, todoList, projectsList, modalContainer);
    } else {
      console.error(`Todo with ID ${elementId} does not exist.`);
    }
  } else if (target.closest(".delete-btn")) {
    (0,_handletodos__WEBPACK_IMPORTED_MODULE_3__.deleteTodoItem)(todoIndex, todoList, projectsList);
...
/* harmony import */ var _handleproject__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./handleproject */ "./src/modules/handleproject.js");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/format.js");
/* harmony import */ var _sharedState__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./sharedState */ "./src/modules/sharedState.js");
    ...
    <div id="view-modal" class="modal active">
        <div class="modal-content">
            ...
            <div class="detail">
                ...
                <p>${(0,date_fns__WEBPACK_IMPORTED_MODULE_4__.format)(new Date(todoList[elementId].dueDate), "do MMM yyy")}</p>
            </div>
            <div class="detail">
...
const defaultValues = (function () {
  ...
  if (!todoList || todoList.length === 0) {
    todoList = [
      ...
      //   "Zee",
      // ),
      new _todo__WEBPACK_IMPORTED_MODULE_0__["default"]("Zee projects", "lorem20", "2025-01-13", "high", false, "Zee"),
      new _todo__WEBPACK_IMPORTED_MODULE_0__["default"]("Zee3 projects", "lorem20", "2025-01-14", "low", false, "Zee"),
      new _todo__WEBPACK_IMPORTED_MODULE_0__["default"]("Zee4 projects", "lorem20", "2025-01-15", "high", false, "Zee"),
