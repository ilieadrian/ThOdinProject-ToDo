...
const defaultValues  = (function () {
    ...
    if (!todoList || todoList.length === 0) {
        todoList = [
            ...
            new Todo('TheOdinProject chapter 2', 'Finish theOdinProject chapter 2', '2024-10-09', 'low', true, 'Home'),
            ...
            //surplus
            new Todo('XYZ', 'Some letters from the alphabet', '2024-10-08', 'high', false, 'Learning'),
            new Todo('TheOdinProject chapter 15', 'Finish theOdinProject chapter 15', '2024-10-09', 'medium', true, 'Home'),
        ];        
    } else {
