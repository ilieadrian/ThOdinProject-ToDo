...
const defaultValues = (function () {
  ...
  if (!todoList || todoList.length === 0) {
    todoList = [
      ...
      //   "Zee",
      // ),
      new Todo("Zee projects", "lorem20", "2024-12-18", "high", false, "Zee"),
      new Todo("Zee3 projects", "lorem20", "2024-12-20", "low", false, "Zee"),
      new Todo("Zee4 projects", "lorem20", "2024-12-19", "high", false, "Zee"),
