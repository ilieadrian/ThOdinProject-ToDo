...
const defaultValues  = (function () {
    ...
    if (!todoList || todoList.length === 0) {
        todoList = [
            new Todo('Write on blog', 'Write about last part from TicTacToe game', '2024-10-05', 'low', false, 'Home'),
            new Todo('TheOdinProject chapter 2', 'Finish theOdinProject chapter 2', '2024-10-04', 'low', true, 'Home'),
            ...
            //surplus
            new Todo('XYZ', 'Some letters from the alphabet', '2024-10-04', 'high', false, 'Learning'),
