...
const defaultValues  = (function () {
    ...
    if (!todoList || todoList.length === 0) {
        ...
        let refreshedTodos = todoList.map(todo => new Todo(todo.title, todo.description, todo.dueDate, todo.priority, todo.status, todo.project));
        console.log("RefreshedTodos", refreshedTodos)
        
        renderUI(projectsList, refreshedTodos);
    }
